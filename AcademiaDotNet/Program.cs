using Sequencia = AcademiaDotNet.Exercicios.Sequenciais;
using Selecao = AcademiaDotNet.Exercicios.Selecao;
using Repeticao = AcademiaDotNet.Exercicios.Repeticao;
