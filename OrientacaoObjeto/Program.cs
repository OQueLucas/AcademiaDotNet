...
namespace OrientacaoObjeto
{
    internal class Program
    {
        static void Main()
        {
            ...
            //Desafios.Mercado.Compra.FazerCompra();

            // ---------------------------------------------------------------------------

            //Desafios.Imobiliaria.CorretoraDeImoveis imoveis = new();

            //imoveis.AdicionarImoveis("Rua Sete, 421", 186000.00, "Casa");
            //imoveis.AdicionarImoveis("Rua Queiroz, 523", 248000.00, "Casa");
            //imoveis.AdicionarImoveis("Rua Zamberlan, 931", 337000.00, "Apartamento");

            //imoveis.ListarImoveis();

            //Console.WriteLine(imoveis.PrecoMedio());

            //imoveis.Menu();

            //Desafios.Agenda.Contatos contatos = new();

            //contatos.AdicionarContato("Lucas", "11 3243 2342", "lucas@gmail.com");
            //contatos.AdicionarContato("Joao", "11 4432 3123", "joao@gmail.com");
            //contatos.AdicionarContato("Alexandre", "11 5435 1236", "alexandre@ufn.com");
            //contatos.AdicionarContato("Rodrigo", "11 5275 6523", "rodrigo@gmail.com");

            //contatos.Menu();

            // ---------------------------------------------------------------------------

            //Desafios.GerenciamentoDeTarefas.GerenciadorDeTarefas tarefas = new();

            //tarefas.AdicionarTarefa("Limpar a casa", "", DateTime.Now);
            //tarefas.AdicionarTarefa("Lavar a louça", "", DateTime.Parse("09/09/2023"));
            //tarefas.AdicionarTarefa("Revisar relatório", "Adicionar graficos novos", DateTime.Parse("10/26/2023"));
            //tarefas.AdicionarTarefa("Entregar relatório", "", DateTime.Parse("10/27/2023"));
            //tarefas.ListarTarefas();
            //tarefas.RemoverTarefa("Entregar relatório");
            //tarefas.ListarTarefas();
            //tarefas.AdicionarTarefa("Remover acesso do Marquinhos", "Relatorio incompleto", DateTime.Parse("10/28/2023"));
            //tarefas.RemoverTarefa("Entregar relatório");
            //tarefas.TarefasHoje();
            ...
            //produtos.AdicionarProduto(43, "cenoura", 4.15, 200);
            //produtos.AdicionarProduto(5431, "rapadura", 17, 200);
            //produtos.AdicionarProduto(43221, "coentro", 3.75, 200);

            //produtos.ListarProdutos();

            //produtos.ConsultarProduto("batata");
